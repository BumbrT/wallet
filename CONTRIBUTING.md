Contributing to JEW Core
============================

The JEW Core project operates an open contributor model where anyone is
...
The following applies to code changes to the JEW Core project, and is not to be
confused with overall JEW Network Protocol consensus changes.

Whether a pull request is merged into JEW Core rests with the project merge
...
Patches that change JEW consensus rules are considerably more involved than
...
Where a patch set proposes to change the JEW consensus, it must have been
...
The project leader is the release manager for each JEW Core release.
