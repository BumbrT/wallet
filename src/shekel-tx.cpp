...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Shekel Core shekel-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  shekel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shekel transaction") + "\n" +
                               "  shekel-tx [options] -create [commands]   " + _("Create hex-encoded shekel transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded shekel transaction
