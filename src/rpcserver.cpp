...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Shekel features */
        {"shekel", "masternode", &masternode, true, true, false},
        {"shekel", "masternodelist", &masternodelist, true, true, false},
        {"shekel", "mnbudget", &mnbudget, true, true, false},
        {"shekel", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"shekel", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"shekel", "mnsync", &mnsync, true, true, false},
        {"shekel", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"shekel", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use shekeld, or the -server option to shekel-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> shekel-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:49473/\n";
}
