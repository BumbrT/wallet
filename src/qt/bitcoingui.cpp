                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Shekel Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a JEW address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and shekel: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Shekel Core"), this);
    aboutAction->setStatusTip(tr("Show information about Shekel Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for JEW"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your JEW addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified JEW addresses"));
    ...
    openAction->setStatusTip(tr("Open a JEW: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Shekel Core help message to get a list with possible JEW command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Shekel Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to JEW network", "", count));
}
...
{
    QString strTitle = tr("Shekel Core"); // default title
