JEW Core version 2.3.0 is now available from:

  <https://github.com/shekel-project/shekel/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/shekel-project/shekel/issues>

Compatibility
==============

JEW Core is extensively tested on multiple operating systems using
...
JEW Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) JEW MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode JEW address
...
JEW Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for JEW (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with JEW (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/shekel-project-translations/).
