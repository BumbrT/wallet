...
This mechanism has been integrated into Bitcore-Node-JEW which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/JEW-Project/insight-api-shekel#web-socket-api](https://github.com/JEW-Project/insight-api-shekel#web-socket-api) 
* API: [https://github.com/JEW-Project/insight-api-shekel#swifttx-transactions](https://github.com/JEW-Project/insight-api-shekel#swifttx-transactions) 
...
By default, the JEW Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the JEW Core daemon:
